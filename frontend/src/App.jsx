    ...
    <div className="min-h-screen bg-[#080808] text-slate-200 selection:bg-indigo-500/30 font-sans pb-40">
      ...
      <header className="max-w-5xl mx-auto px-6 py-10 flex justify-between items-center">
        ...
        {conversation.length > 0 && (
          <button onClick={() => setConversation([])} className="text-slate-500 hover:text-white transition-colors">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {history.map((h, i) => (
                      <button 
                        ...
                        className="px-4 py-2 bg-white/5 border border-white/5 rounded-full text-xs text-slate-500 hover:text-white hover:border-white/20 transition-all"
                      >
                        {h}
                      </button>
                    ))}
